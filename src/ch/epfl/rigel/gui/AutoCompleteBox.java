...
/**
 * Code inspired from stack overflow post
...
public class AutoCompleteBox {
    ...
    public static void autoCompleteComboBoxPlus(ComboBox<City> comboBox, CityCatalogue cityCatalogue, int queryLimit) {
        ...
        ComboBoxListViewSkin<City> comboBoxListViewSkin = new ComboBoxListViewSkin<City>(comboBox);
    ...
    public static<City> City getComboBoxValue(ComboBox<City> comboBox){
        if (comboBox.getSelectionModel().getSelectedIndex() < 0) {
            return null;
        } else {
